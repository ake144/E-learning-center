...
export default function MyLearningPage() {
  ...
  const getButtonProps = (progress: number, slug: string, id?: number) => {
    const onClick = id ? () => router.push(`/my-learning/goal/${id}`) : () => router.push(`/my-learning/${slug}`)
    if (progress === 100) {
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardHeader>
                ...
                <CardDescription>Track your objectives and deadlines</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {studyGoals.map((goal) => {
                    const { text, variant, onClick } = getButtonProps(goal.progress, '', goal.id)
                    return (
                      <div
                        key={goal.id}
                        className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                ...
                <Card className="border border-gray-200 shadow-sm">
                  ...
                  <CardContent>
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">Create your first flashcard set to start practicing active recall</p>
                      <Button className="bg-blue-600 hover:bg-blue-700 text-white">
